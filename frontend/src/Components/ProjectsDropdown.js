...
function ProjectsDropdown({ projects, selectProject, left, width, defaultProjectName }) {
    return (
        <div className='projects' style={{ left: left, maxWidth: width }}>
            ...
            <button onClick={() => selectProject({ color: "white", project_id: null, name: defaultProjectName ? defaultProjectName : "No Project" })} style={{ color: "white" }}>{defaultProjectName ? defaultProjectName : "No Project"}</button>
